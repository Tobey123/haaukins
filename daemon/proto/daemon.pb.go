...
type CreateEventRequest struct {
	...
	Challenges           []string `protobuf:"bytes,4,rep,name=challenges,proto3" json:"challenges,omitempty"`
...
func (m *CreateEventRequest) GetChallenges() []string {
	if m != nil {
		return m.Challenges
	}
	return nil
...
type ListEventsResponse_Events struct {
	...
	ChallengeCount       int32    `protobuf:"varint,4,opt,name=challengeCount,proto3" json:"challengeCount,omitempty"`
...
func (m *ListEventsResponse_Events) GetChallengeCount() int32 {
	if m != nil {
...
type ResetChallengeRequest struct {
	ChallengeTag         string   `protobuf:"bytes,1,opt,name=challengeTag,proto3" json:"challengeTag,omitempty"`
...
func (m *ResetChallengeRequest) Reset()         { *m = ResetChallengeRequest{} }
func (m *ResetChallengeRequest) String() string { return proto.CompactTextString(m) }
...
func (m *ResetChallengeRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ResetChallengeRequest.Unmarshal(m, b)
}
func (m *ResetChallengeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ResetChallengeRequest.Marshal(b, m, deterministic)
}
func (m *ResetChallengeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResetChallengeRequest.Merge(m, src)
}
func (m *ResetChallengeRequest) XXX_Size() int {
	return xxx_messageInfo_ResetChallengeRequest.Size(m)
}
func (m *ResetChallengeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ResetChallengeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ResetChallengeRequest proto.InternalMessageInfo

func (m *ResetChallengeRequest) GetChallengeTag() string {
	if m != nil {
...
func (m *ResetChallengeRequest) GetEventTag() string {
	if m != nil {
		return m.EventTag
	}
	return ""
...
func (m *ResetChallengeRequest) GetTeams() []*Team {
	if m != nil {
		return m.Teams
	}
	return nil
...
type UpdateChallengeFileResponse struct {
...
func (m *UpdateChallengeFileResponse) Reset()         { *m = UpdateChallengeFileResponse{} }
func (m *UpdateChallengeFileResponse) String() string { return proto.CompactTextString(m) }
func (*UpdateChallengeFileResponse) ProtoMessage()    {}
func (*UpdateChallengeFileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ec90cbc4aa12fc6, []int{13}
}

func (m *UpdateChallengeFileResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UpdateChallengeFileResponse.Unmarshal(m, b)
}
func (m *UpdateChallengeFileResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_UpdateChallengeFileResponse.Marshal(b, m, deterministic)
}
func (m *UpdateChallengeFileResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateChallengeFileResponse.Merge(m, src)
}
func (m *UpdateChallengeFileResponse) XXX_Size() int {
	return xxx_messageInfo_UpdateChallengeFileResponse.Size(m)
}
func (m *UpdateChallengeFileResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateChallengeFileResponse.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateChallengeFileResponse proto.InternalMessageInfo

func (m *UpdateChallengeFileResponse) GetMsg() string {
	if m != nil {
		return m.Msg
	}
	return ""
...
type ListChallengesResponse struct {
	Challenges           []*ListChallengesResponse_Challenge `protobuf:"bytes,1,rep,name=challenges,proto3" json:"challenges,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}

func (m *ListChallengesResponse) Reset()         { *m = ListChallengesResponse{} }
func (m *ListChallengesResponse) String() string { return proto.CompactTextString(m) }
...
func (m *ListChallengesResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListChallengesResponse.Unmarshal(m, b)
}
func (m *ListChallengesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListChallengesResponse.Marshal(b, m, deterministic)
}
func (m *ListChallengesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListChallengesResponse.Merge(m, src)
}
func (m *ListChallengesResponse) XXX_Size() int {
	return xxx_messageInfo_ListChallengesResponse.Size(m)
}
func (m *ListChallengesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ListChallengesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ListChallengesResponse proto.InternalMessageInfo

func (m *ListChallengesResponse) GetChallenges() []*ListChallengesResponse_Challenge {
	if m != nil {
		return m.Challenges
	}
	return nil
...
type ListChallengesResponse_Challenge struct {
...
func (m *ListChallengesResponse_Challenge) Reset()         { *m = ListChallengesResponse_Challenge{} }
func (m *ListChallengesResponse_Challenge) String() string { return proto.CompactTextString(m) }
func (*ListChallengesResponse_Challenge) ProtoMessage()    {}
func (*ListChallengesResponse_Challenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ec90cbc4aa12fc6, []int{14, 0}
}

func (m *ListChallengesResponse_Challenge) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListChallengesResponse_Challenge.Unmarshal(m, b)
}
func (m *ListChallengesResponse_Challenge) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ListChallengesResponse_Challenge.Marshal(b, m, deterministic)
}
func (m *ListChallengesResponse_Challenge) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListChallengesResponse_Challenge.Merge(m, src)
}
func (m *ListChallengesResponse_Challenge) XXX_Size() int {
	return xxx_messageInfo_ListChallengesResponse_Challenge.Size(m)
}
func (m *ListChallengesResponse_Challenge) XXX_DiscardUnknown() {
	xxx_messageInfo_ListChallengesResponse_Challenge.DiscardUnknown(m)
}

var xxx_messageInfo_ListChallengesResponse_Challenge proto.InternalMessageInfo

func (m *ListChallengesResponse_Challenge) GetTags() []string {
	if m != nil {
		return m.Tags
	}
	return nil
...
func (m *ListChallengesResponse_Challenge) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ListChallengesResponse_Challenge) GetDockerImageCount() int32 {
	if m != nil {
...
func (m *ListChallengesResponse_Challenge) GetVboxImageCount() int32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ResetChallengeRequest)(nil), "ResetChallengeRequest")
	proto.RegisterType((*UpdateChallengeFileResponse)(nil), "UpdateChallengeFileResponse")
	proto.RegisterType((*ListChallengesResponse)(nil), "ListChallengesResponse")
	proto.RegisterType((*ListChallengesResponse_Challenge)(nil), "ListChallengesResponse.Challenge")
...
var fileDescriptor_3ec90cbc4aa12fc6 = []byte{
	...
	,
}
...
type DaemonClient interface {
	...
	UpdateChallengesFile(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UpdateChallengeFileResponse, error)
	ListChallenges(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListChallengesResponse, error)
	ResetChallenge(ctx context.Context, in *ResetChallengeRequest, opts ...grpc.CallOption) (Daemon_ResetChallengeClient, error)
...
func (c *daemonClient) UpdateChallengesFile(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UpdateChallengeFileResponse, error) {
	out := new(UpdateChallengeFileResponse)
	err := c.cc.Invoke(ctx, "/Daemon/UpdateChallengesFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) ListChallenges(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListChallengesResponse, error) {
	out := new(ListChallengesResponse)
	err := c.cc.Invoke(ctx, "/Daemon/ListChallenges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonClient) ResetChallenge(ctx context.Context, in *ResetChallengeRequest, opts ...grpc.CallOption) (Daemon_ResetChallengeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Daemon_serviceDesc.Streams[3], "/Daemon/ResetChallenge", opts...)
	if err != nil {
		return nil, err
	}
	x := &daemonResetChallengeClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Daemon_ResetChallengeClient interface {
	Recv() (*ResetTeamStatus, error)
	grpc.ClientStream
}

type daemonResetChallengeClient struct {
	grpc.ClientStream
}

func (x *daemonResetChallengeClient) Recv() (*ResetTeamStatus, error) {
...
type DaemonServer interface {
	...
	UpdateChallengesFile(context.Context, *Empty) (*UpdateChallengeFileResponse, error)
	ListChallenges(context.Context, *Empty) (*ListChallengesResponse, error)
	ResetChallenge(*ResetChallengeRequest, Daemon_ResetChallengeServer) error
...
func (*UnimplementedDaemonServer) UpdateChallengesFile(ctx context.Context, req *Empty) (*UpdateChallengeFileResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateChallengesFile not implemented")
}
func (*UnimplementedDaemonServer) ListChallenges(ctx context.Context, req *Empty) (*ListChallengesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListChallenges not implemented")
}
func (*UnimplementedDaemonServer) ResetChallenge(req *ResetChallengeRequest, srv Daemon_ResetChallengeServer) error {
	return status.Errorf(codes.Unimplemented, "method ResetChallenge not implemented")
}
...
func _Daemon_UpdateChallengesFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServer).UpdateChallengesFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Daemon/UpdateChallengesFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServer).UpdateChallengesFile(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Daemon_ListChallenges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServer).ListChallenges(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Daemon/ListChallenges",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServer).ListChallenges(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Daemon_ResetChallenge_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ResetChallengeRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DaemonServer).ResetChallenge(m, &daemonResetChallengeServer{stream})
}

type Daemon_ResetChallengeServer interface {
	Send(*ResetTeamStatus) error
	grpc.ServerStream
}

type daemonResetChallengeServer struct {
	grpc.ServerStream
}

func (x *daemonResetChallengeServer) Send(m *ResetTeamStatus) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Daemon_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateChallengesFile",
			Handler:    _Daemon_UpdateChallengesFile_Handler,
		},
		{
			MethodName: "ListChallenges",
			Handler:    _Daemon_ListChallenges_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ResetChallenge",
			Handler:       _Daemon_ResetChallenge_Handler,
			ServerStreams: true,
		},
		{
